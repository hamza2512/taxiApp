...
export interface ThemeColors {
  ...
  lightwhite:ColorValue;
  fullwhite:ColorValue;
  seagreen:ColorValue;
  inputcolor:ColorValue;
  red:ColorValue;
  date:ColorValue;
  purewhite:ColorValue;
}
